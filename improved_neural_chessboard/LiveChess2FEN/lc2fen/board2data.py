...
def regenerate_data_state(data_path):
    ...
    os.mkdir(data_path + '/pieces/br/')
    os.mkdir(data_path + '/pieces/bn/')
    os.mkdir(data_path + '/pieces/bb/')
    os.mkdir(data_path + '/pieces/bq/')
    os.mkdir(data_path + '/pieces/bk/')
    os.mkdir(data_path + '/pieces/bp/')
    os.mkdir(data_path + '/pieces/wr/')
    os.mkdir(data_path + '/pieces/wn/')
    os.mkdir(data_path + '/pieces/wb/')
    os.mkdir(data_path + '/pieces/wq/')
    os.mkdir(data_path + '/pieces/wk/')
    os.mkdir(data_path + '/pieces/wp/')
