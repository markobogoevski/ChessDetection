...
def split_board_image(board_image, square_corners, output_name, out_dir,
    ...
    for row_ind in range(1, 9):  # Square_corners is 9x9
        for col_ind in range(0, 8):
            ...
            if orientation == 'front' and row_ind > 4:
                bl_corner[1] -= 20
                br_corner[1] -= 20
                tl_corner[1] -= 20
            elif orientation == 'behind' and row_ind > 4:
                bl_corner[1] += 20
                br_corner[1] += 20
                tl_corner[1] += 20
            ...
            # Expand top left and top right corners
